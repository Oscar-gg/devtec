const unknownLanguageColor = "#808080"; // Default color for unknown languages

export const getColorByLanguage = (language: string | null | undefined) => {
  if (!language) return unknownLanguageColor;

  const colorInfo = githubColors[language];
  return colorInfo?.color ?? unknownLanguageColor;
};

// https://github.com/ozh/github-colors/blob/master/colors.json
export const githubColors: Record<
  string,
